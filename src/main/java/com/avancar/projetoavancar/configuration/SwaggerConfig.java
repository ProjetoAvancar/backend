package com.avancar.projetoavancar.configuration;
...
public class SwaggerConfig {
	...
	public OpenAPI springBlogPessoalOpenAPI() {
        ...
        return new OpenAPI()
				.info(new Info()
					.title("Projeto Avançar")
					.description("Projeto Avançar - Generation Brasil")
					.version("v0.0.1")
				.license(new License()
				...
				.contact(new Contact()
					.name("Equipe Avançar")
					.url("https://linktr.ee/projavancar")
					.email("projetoavancar.generation@gmail.com")))
